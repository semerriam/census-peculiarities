...
* [VA-SQLite-adjusted-census-exploration.ipynb](VA-SQLite-adjusted-census-exploration.ipynb) is an exploration of Virginia's Adjusted Census files using SQLite in pandas to identify important tables for importing into the census_chaos notebook.
